...
namespace AdventOfCode2016.Day1
{
    ...
    [TestFixture]
    public class Answer_the_first_half_of_the_puzzle
    {
        [Test]
        public void Test()
        {
    ...
    [TestFixture]
    public class Answer_the_second_half_of_the_puzzle
    {
        [Test]
        public void Test()
        {
            ...
            var blockCalculator = new BlockCalculator();
            blockCalculator.Calculate(moveset);

            var doubleVisitedCoordinate = blockCalculator.FirstDoubleVisitedCoordinate;
            var coordinates = doubleVisitedCoordinate.Split('_');
            var blocksAway = Math.Abs(int.Parse(coordinates[0])) + Math.Abs(int.Parse(coordinates[1]));
        }
    }
}
